class GameoverScene extends Phaser.Scene {
    ...
    this.nivellActual = level
     ...
     create() {
        ...
        var fonsGameover = this.add.image(this.game.renderer.width / 2, this.game.renderer.height / 2, "gameover").setDepth(1);
        fonsGameover.scaleX = 2;
        fonsGameover.scaleY = 2;
